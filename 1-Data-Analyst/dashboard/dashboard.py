...
def create_daily_orders_df(df):
    """
    Membuat DataFrame harian berisi jumlah order dan total revenue.
    """
...
def create_sum_order_items_df(df):
    """
    Membuat DataFrame jumlah penjualan tiap produk.
    """
...
def create_bygender_df(df):
    """
    Membuat DataFrame jumlah customer berdasarkan gender.
    """
...
def create_byage_df(df):
    """
    Membuat DataFrame jumlah customer berdasarkan kelompok umur.
    """
...
def create_bystate_df(df):
    """
    Membuat DataFrame jumlah customer berdasarkan state.
    """
...
def create_rfm_df(df):
    """
    Membuat DataFrame RFM (Recency, Frequency, Monetary) untuk customer.
    """
    rfm_df = df.groupby(by="customer_id", as_index=False).agg({
        "order_date": "max", # tanggal order terakhir
        "order_id": "nunique",
        "total_price": "sum"
    })
...
# Pastikan kolom tanggal bertipe datetime dan urut
